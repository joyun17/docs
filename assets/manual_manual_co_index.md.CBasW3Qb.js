...
const __pageData = JSON.parse("{\"title\":\"사용자 매뉴얼 원가관리\",\"description\":\"\",\"frontmatter\":{},\"headers\":[],\"relativePath\":\"manual/manual_co/index.md\",\"filePath\":\"manual/manual_co/index.md\"}");
const _sfc_main = {name:"manual/manual_co/index.md"};
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  const _component_COsystem = resolveComponent("COsystem");

  return (openBlock(), createElementBlock("div", null, [
    _cache[5] || (_cache[5] = createBaseVNode("h1", {
      id: "사용자-매뉴얼-원가관리",
      tabindex: "-1"
    }, [
      createTextVNode("사용자 매뉴얼 원가관리 "),
      createBaseVNode("a", {
        class: "header-anchor",
        href: "#사용자-매뉴얼-원가관리",
        "aria-label": "Permalink to \"사용자 매뉴얼 원가관리\""
      }, "​")
    ], -1)),
    ...
    createVNode(_component_ClientOnly, null, {
      default: withCtx(() => [
        createVNode(_component_COsystem)
      ]),
      _: 1
    }),
    _cache[8] || (_cache[8] = createStaticVNode("<h3 id=\"구현내용\" tabindex=\"-1\">구현내용 <a class=\"header-anchor\" href=\"#구현내용\" aria-label=\"Permalink to &quot;구현내용&quot;\">​</a></h3><ul><li>제품별 계획/실적 분석</li><li>수익성 분석 -&gt; (제품, 고객)</li><li>조직 KPI 운영 관리</li><li><strong>월 결산 실적</strong> : 경영정보 활용 및 현업 Feedback 강화</li><li><strong>사업계획 정보 관리</strong> : 현장 관리 수준의 제품별 계획원가 제공</li></ul><h2 id=\"메뉴구조도\" tabindex=\"-1\">메뉴구조도 <a class=\"header-anchor\" href=\"#메뉴구조도\" aria-label=\"Permalink to &quot;메뉴구조도&quot;\">​</a></h2><table class=\"no-stripe\"><tr><td><img src=\"" + _imports_0 + "\" alt=\"\" data-zoomable></td><td><img src=\"" + _imports_1 + "\" alt=\"\" data-zoomable></td><td rowspan=\"2\"><img src=\"" + _imports_2 + "\" alt=\"\" data-zoomable></td></tr><tr><td><img src=\"" + _imports_3 + "\" alt=\"\" data-zoomable></td><td><img src=\"" + _imports_4 + "\" alt=\"\" data-zoomable></td></tr></table>", 4))
  ]))
}
