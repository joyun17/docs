...
const __pageData = JSON.parse("{\"title\":\"기준관리 플로우차트\",\"description\":\"\",\"frontmatter\":{},\"headers\":[],\"relativePath\":\"manual/manual_fi_04/com/com_flowchart.md\",\"filePath\":\"manual/manual_fi_04/com/com_flowchart.md\"}");
const _sfc_main = {name:"manual/manual_fi_04/com/com_flowchart.md"};
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  const _component_Fi04ComFlowChart = resolveComponent("Fi04ComFlowChart");
  const _component_ClientOnly = resolveComponent("ClientOnly");

  return (openBlock(), createElementBlock("div", null, [
    _cache[4] || (_cache[4] = createBaseVNode("h1", {
      id: "기준관리-플로우차트",
      tabindex: "-1"
    }, [
      createTextVNode("기준관리 플로우차트 "),
      createBaseVNode("a", {
        class: "header-anchor",
        href: "#기준관리-플로우차트",
        "aria-label": "Permalink to \"기준관리 플로우차트\""
      }, "​")
    ], -1)),
      ...
      createBaseVNode("tr", _hoisted_2, [
        ...
        createBaseVNode("td", _hoisted_3, [
          createVNode(_component_ClientOnly, null, {
            default: withCtx(() => [
              createVNode(_component_Fi04ComFlowChart)
            ]),
            _: 1
          })
        ])
