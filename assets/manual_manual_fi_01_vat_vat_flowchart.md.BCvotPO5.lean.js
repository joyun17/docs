...
const __pageData = JSON.parse("{\"title\":\"세금계산서전표 관리 플로우차트\",\"description\":\"\",\"frontmatter\":{},\"headers\":[],\"relativePath\":\"manual/manual_fi_01/vat/vat_flowchart.md\",\"filePath\":\"manual/manual_fi_01/vat/vat_flowchart.md\"}");
const _sfc_main = {name:"manual/manual_fi_01/vat/vat_flowchart.md"};
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  const _component_FI01vatFlowChart = resolveComponent("FI01vatFlowChart");
  const _component_ClientOnly = resolveComponent("ClientOnly");

  return (openBlock(), createElementBlock("div", null, [
    _cache[6] || (_cache[6] = createBaseVNode("h1", {
      id: "세금계산서전표-관리-플로우차트",
      tabindex: "-1"
    }, [
      createTextVNode("세금계산서전표 관리 플로우차트 "),
      createBaseVNode("a", {
        class: "header-anchor",
        href: "#세금계산서전표-관리-플로우차트",
        "aria-label": "Permalink to \"세금계산서전표 관리 플로우차트\""
      }, "​")
    ], -1)),
    ...
    createBaseVNode("table", _hoisted_1, [
      ...
      _cache[2] || (_cache[2] = createBaseVNode("tr", null, [
        ...
        createBaseVNode("td", null, "세금계산서 전표관리"),
      ...
      createBaseVNode("tr", _hoisted_2, [
        _cache[0] || (_cache[0] = createBaseVNode("td", null, "국세청", -1)),
        createBaseVNode("td", _hoisted_3, [
          createVNode(_component_ClientOnly, null, {
            default: withCtx(() => [
              createVNode(_component_FI01vatFlowChart)
            ]),
            _: 1
          })
        ])
...
const vat_flowchart = /*#__PURE__*/_export_sfc(_sfc_main, [['render',_sfc_render]]);

export { __pageData, vat_flowchart as default };
