...
const __pageData = JSON.parse("{\"title\":\"자금집행 지급관리 플로우차트\",\"description\":\"\",\"frontmatter\":{},\"headers\":[],\"relativePath\":\"manual/manual_tr/trp/trp_flowchart.md\",\"filePath\":\"manual/manual_tr/trp/trp_flowchart.md\"}");
const _sfc_main = {name:"manual/manual_tr/trp/trp_flowchart.md"};
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  const _component_TrTrpFlowChart = resolveComponent("TrTrpFlowChart");
  const _component_ClientOnly = resolveComponent("ClientOnly");

  return (openBlock(), createElementBlock("div", null, [
    _cache[4] || (_cache[4] = createBaseVNode("h1", {
      id: "자금집행-지급관리-플로우차트",
      tabindex: "-1"
    }, [
      createTextVNode("자금집행 지급관리 플로우차트 "),
      createBaseVNode("a", {
        class: "header-anchor",
        href: "#자금집행-지급관리-플로우차트",
        "aria-label": "Permalink to \"자금집행 지급관리 플로우차트\""
      }, "​")
    ], -1)),
      ...
      createBaseVNode("tr", _hoisted_2, [
        ...
        createBaseVNode("td", _hoisted_3, [
          createVNode(_component_ClientOnly, null, {
            default: withCtx(() => [
              createVNode(_component_TrTrpFlowChart)
            ]),
            _: 1
          })
        ])
...
const trp_flowchart = /*#__PURE__*/_export_sfc(_sfc_main, [['render',_sfc_render]]);

export { __pageData, trp_flowchart as default };
