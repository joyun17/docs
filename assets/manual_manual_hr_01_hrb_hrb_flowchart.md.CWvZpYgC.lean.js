...
const __pageData = JSON.parse("{\"title\":\"인사정보기준관리 플로우차트\",\"description\":\"\",\"frontmatter\":{},\"headers\":[],\"relativePath\":\"manual/manual_hr_01/hrb/hrb_flowchart.md\",\"filePath\":\"manual/manual_hr_01/hrb/hrb_flowchart.md\"}");
const _sfc_main = {name:"manual/manual_hr_01/hrb/hrb_flowchart.md"};
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  const _component_HR01hrbFlowChart = resolveComponent("HR01hrbFlowChart");
  ...
  return (openBlock(), createElementBlock("div", null, [
    ...
    createBaseVNode("table", _hoisted_1, [
      ...
      _cache[2] || (_cache[2] = createBaseVNode("tr", null, [
        ...
        createBaseVNode("td", null, "인사정보기준관리"),
      ...
      createBaseVNode("tr", _hoisted_2, [
        ...
        createBaseVNode("td", _hoisted_3, [
          createVNode(_component_ClientOnly, null, {
            default: withCtx(() => [
              createVNode(_component_HR01hrbFlowChart)
            ]),
            _: 1
          })
        ])
