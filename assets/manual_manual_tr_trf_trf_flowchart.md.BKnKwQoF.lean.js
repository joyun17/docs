...
const __pageData = JSON.parse("{\"title\":\"외환관리 플로우차트\",\"description\":\"\",\"frontmatter\":{},\"headers\":[],\"relativePath\":\"manual/manual_tr/trf/trf_flowchart.md\",\"filePath\":\"manual/manual_tr/trf/trf_flowchart.md\"}");
const _sfc_main = {name:"manual/manual_tr/trf/trf_flowchart.md"};
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  const _component_TrTrfFlowChart = resolveComponent("TrTrfFlowChart");
  const _component_ClientOnly = resolveComponent("ClientOnly");

  return (openBlock(), createElementBlock("div", null, [
    _cache[4] || (_cache[4] = createBaseVNode("h1", {
      id: "외환관리-플로우차트",
      tabindex: "-1"
    }, [
      createTextVNode("외환관리 플로우차트 "),
      createBaseVNode("a", {
        class: "header-anchor",
        href: "#외환관리-플로우차트",
        "aria-label": "Permalink to \"외환관리 플로우차트\""
      }, "​")
    ], -1)),
      ...
      createBaseVNode("tr", null, [
        ...
        createBaseVNode("td", _hoisted_2, [
          createVNode(_component_ClientOnly, null, {
            default: withCtx(() => [
              createVNode(_component_TrTrfFlowChart)
            ]),
            _: 1
          })
        ])
...
const trf_flowchart = /*#__PURE__*/_export_sfc(_sfc_main, [['render',_sfc_render]]);

export { __pageData, trf_flowchart as default };
