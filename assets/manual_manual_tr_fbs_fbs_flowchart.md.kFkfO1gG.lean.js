...
const __pageData = JSON.parse("{\"title\":\"자금집행 펌뱅킹 플로우차트\",\"description\":\"\",\"frontmatter\":{},\"headers\":[],\"relativePath\":\"manual/manual_tr/fbs/fbs_flowchart.md\",\"filePath\":\"manual/manual_tr/fbs/fbs_flowchart.md\"}");
const _sfc_main = {name:"manual/manual_tr/fbs/fbs_flowchart.md"};
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  const _component_TrFbsFlowChart = resolveComponent("TrFbsFlowChart");
  const _component_ClientOnly = resolveComponent("ClientOnly");

  return (openBlock(), createElementBlock("div", null, [
    _cache[4] || (_cache[4] = createBaseVNode("h1", {
      id: "자금집행-펌뱅킹-플로우차트",
      tabindex: "-1"
    }, [
      createTextVNode("자금집행 펌뱅킹 플로우차트 "),
      createBaseVNode("a", {
        class: "header-anchor",
        href: "#자금집행-펌뱅킹-플로우차트",
        "aria-label": "Permalink to \"자금집행 펌뱅킹 플로우차트\""
      }, "​")
    ], -1)),
    ...
    createBaseVNode("table", _hoisted_1, [
      ...
      createBaseVNode("tr", _hoisted_2, [
        _cache[0] || (_cache[0] = createBaseVNode("td", { style: {"font-size":"14px"} }, "자금 담당자", -1)),
        createBaseVNode("td", _hoisted_3, [
          createVNode(_component_ClientOnly, null, {
            default: withCtx(() => [
              createVNode(_component_TrFbsFlowChart)
            ]),
            _: 1
          })
        ])
...
const fbs_flowchart = /*#__PURE__*/_export_sfc(_sfc_main, [['render',_sfc_render]]);

export { __pageData, fbs_flowchart as default };
