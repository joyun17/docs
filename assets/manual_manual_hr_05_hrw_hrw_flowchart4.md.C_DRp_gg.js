...
const __pageData = JSON.parse("{\"title\":\"대여금 관리 플로우차트\",\"description\":\"\",\"frontmatter\":{},\"headers\":[],\"relativePath\":\"manual/manual_hr_05/hrw/hrw_flowchart4.md\",\"filePath\":\"manual/manual_hr_05/hrw/hrw_flowchart4.md\"}");
const _sfc_main = {name:"manual/manual_hr_05/hrw/hrw_flowchart4.md"};

const _hoisted_1 = { class: "no-stripe table-process" };
const _hoisted_2 = { style: {"height":"80px"} };
const _hoisted_3 = {
  colspan: "5",
  rowspan: "3",
  style: {"padding":"0"}
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  const _component_HR05hrwFlowChart4 = resolveComponent("HR05hrwFlowChart4");
  const _component_ClientOnly = resolveComponent("ClientOnly");

  return (openBlock(), createElementBlock("div", null, [
    _cache[6] || (_cache[6] = createBaseVNode("h1", {
      id: "대여금-관리-플로우차트",
      tabindex: "-1"
    }, [
      createTextVNode("대여금 관리 플로우차트 "),
      createBaseVNode("a", {
        class: "header-anchor",
        href: "#대여금-관리-플로우차트",
        "aria-label": "Permalink to \"대여금 관리 플로우차트\""
      }, "​")
    ], -1)),
    ...
    createBaseVNode("table", _hoisted_1, [
      ...
      _cache[2] || (_cache[2] = createBaseVNode("tr", null, [
        ...
        createBaseVNode("td", null, "대여금 관리"),
      ...
      createBaseVNode("tr", _hoisted_2, [
        _cache[0] || (_cache[0] = createBaseVNode("td", { style: {"padding":"1px"} }, "사내복지기금", -1)),
        createBaseVNode("td", _hoisted_3, [
          createVNode(_component_ClientOnly, null, {
            default: withCtx(() => [
              createVNode(_component_HR05hrwFlowChart4)
            ]),
            _: 1
          })
        ])
      ...
      _cache[5] || (_cache[5] = createBaseVNode("tr", { style: {"height":"120px"} }, [
        createBaseVNode("td", null, "직원")
      ], -1))
    ])
  ]))
}
const hrw_flowchart4 = /*#__PURE__*/_export_sfc(_sfc_main, [['render',_sfc_render]]);

export { __pageData, hrw_flowchart4 as default };
