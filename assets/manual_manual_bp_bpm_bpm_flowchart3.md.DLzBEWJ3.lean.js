...
const __pageData = JSON.parse("{\"title\":\"계획손익 산출 플로우차트\",\"description\":\"\",\"frontmatter\":{},\"headers\":[],\"relativePath\":\"manual/manual_bp/bpm/bpm_flowchart3.md\",\"filePath\":\"manual/manual_bp/bpm/bpm_flowchart3.md\"}");
const _sfc_main = {name:"manual/manual_bp/bpm/bpm_flowchart3.md"};
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  const _component_BpBpmFlowChart_03 = resolveComponent("BpBpmFlowChart_03");
  const _component_ClientOnly = resolveComponent("ClientOnly");

  return (openBlock(), createElementBlock("div", null, [
    _cache[5] || (_cache[5] = createBaseVNode("h1", {
      id: "계획손익-산출-플로우차트",
      tabindex: "-1"
    }, [
      createTextVNode("계획손익 산출 플로우차트 "),
      createBaseVNode("a", {
        class: "header-anchor",
        href: "#계획손익-산출-플로우차트",
        "aria-label": "Permalink to \"계획손익 산출 플로우차트\""
      }, "​")
    ], -1)),
      ...
      createBaseVNode("tr", null, [
        ...
        createBaseVNode("td", _hoisted_2, [
          createVNode(_component_ClientOnly, null, {
            default: withCtx(() => [
              createVNode(_component_BpBpmFlowChart_03)
            ]),
            _: 1
          })
        ])
...
const bpm_flowchart3 = /*#__PURE__*/_export_sfc(_sfc_main, [['render',_sfc_render]]);

export { __pageData, bpm_flowchart3 as default };
