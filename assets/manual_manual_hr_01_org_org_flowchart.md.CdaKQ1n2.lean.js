...
const __pageData = JSON.parse("{\"title\":\"조직관리 플로우차트\",\"description\":\"\",\"frontmatter\":{},\"headers\":[],\"relativePath\":\"manual/manual_hr_01/org/org_flowchart.md\",\"filePath\":\"manual/manual_hr_01/org/org_flowchart.md\"}");
const _sfc_main = {name:"manual/manual_hr_01/org/org_flowchart.md"};

const _hoisted_1 = { class: "no-stripe table-process" };
const _hoisted_2 = { style: {"height":"400px"} };
const _hoisted_3 = {
  colspan: "5",
  rowspan: "2",
  style: {"padding":"0"}
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  const _component_HR01orgFlowChart = resolveComponent("HR01orgFlowChart");
  const _component_ClientOnly = resolveComponent("ClientOnly");

  return (openBlock(), createElementBlock("div", null, [
    _cache[4] || (_cache[4] = createBaseVNode("h1", {
      id: "조직관리-플로우차트",
      tabindex: "-1"
    }, [
      createTextVNode("조직관리 플로우차트 "),
      createBaseVNode("a", {
        class: "header-anchor",
        href: "#조직관리-플로우차트",
        "aria-label": "Permalink to \"조직관리 플로우차트\""
      }, "​")
    ], -1)),
      ...
      createBaseVNode("tr", _hoisted_2, [
        ...
        createBaseVNode("td", _hoisted_3, [
          createVNode(_component_ClientOnly, null, {
            default: withCtx(() => [
              createVNode(_component_HR01orgFlowChart)
            ]),
            _: 1
          })
        ])
...
const org_flowchart = /*#__PURE__*/_export_sfc(_sfc_main, [['render',_sfc_render]]);

export { __pageData, org_flowchart as default };
