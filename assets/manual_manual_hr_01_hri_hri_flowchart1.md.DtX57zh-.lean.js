...
const __pageData = JSON.parse("{\"title\":\"임직원관리 플로우차트\",\"description\":\"\",\"frontmatter\":{},\"headers\":[],\"relativePath\":\"manual/manual_hr_01/hri/hri_flowchart1.md\",\"filePath\":\"manual/manual_hr_01/hri/hri_flowchart1.md\"}");
const _sfc_main = {name:"manual/manual_hr_01/hri/hri_flowchart1.md"};
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  const _component_HR01hriFlowChart1 = resolveComponent("HR01hriFlowChart1");
  const _component_ClientOnly = resolveComponent("ClientOnly");

  return (openBlock(), createElementBlock("div", null, [
    _cache[6] || (_cache[6] = createBaseVNode("h1", {
      id: "임직원관리-플로우차트",
      tabindex: "-1"
    }, [
      createTextVNode("임직원관리 플로우차트 "),
      createBaseVNode("a", {
        class: "header-anchor",
        href: "#임직원관리-플로우차트",
        "aria-label": "Permalink to \"임직원관리 플로우차트\""
      }, "​")
    ], -1)),
    ...
    createBaseVNode("table", _hoisted_1, [
      ...
      _cache[2] || (_cache[2] = createBaseVNode("tr", null, [
        ...
        createBaseVNode("td", null, "인사정보"),
        createBaseVNode("th", null, "Task"),
        createBaseVNode("td", null, "임직원 관리"),
      ...
      createBaseVNode("tr", null, [
        _cache[0] || (_cache[0] = createBaseVNode("td", { style: {"padding":"1px"} }, "경영관리팀", -1)),
        createBaseVNode("td", _hoisted_2, [
          createVNode(_component_ClientOnly, null, {
            default: withCtx(() => [
              createVNode(_component_HR01hriFlowChart1)
            ]),
            _: 1
          })
        ])
      ]),
      _cache[4] || (_cache[4] = createBaseVNode("tr", { style: {"height":"100px"} }, [
        createBaseVNode("td", null, "임직원")
      ], -1)),
      _cache[5] || (_cache[5] = createBaseVNode("tr", { style: {"height":"100px"} }, [
        createBaseVNode("td", null, "타 시스템")
      ], -1))
    ])
  ]))
}
const hri_flowchart1 = /*#__PURE__*/_export_sfc(_sfc_main, [['render',_sfc_render]]);

export { __pageData, hri_flowchart1 as default };
