...
const __pageData = JSON.parse("{\"title\":\"연동전표 관리 플로우차트\",\"description\":\"\",\"frontmatter\":{},\"headers\":[],\"relativePath\":\"manual/manual_fi_01/fig/fig_flowchart.md\",\"filePath\":\"manual/manual_fi_01/fig/fig_flowchart.md\"}");
const _sfc_main = {name:"manual/manual_fi_01/fig/fig_flowchart.md"};
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  const _component_FI01figFlowChart = resolveComponent("FI01figFlowChart");
  const _component_ClientOnly = resolveComponent("ClientOnly");

  return (openBlock(), createElementBlock("div", null, [
    _cache[5] || (_cache[5] = createBaseVNode("h1", {
      id: "연동전표-관리-플로우차트",
      tabindex: "-1"
    }, [
      createTextVNode("연동전표 관리 플로우차트 "),
      createBaseVNode("a", {
        class: "header-anchor",
        href: "#연동전표-관리-플로우차트",
        "aria-label": "Permalink to \"연동전표 관리 플로우차트\""
      }, "​")
    ], -1)),
    ...
    createBaseVNode("table", _hoisted_1, [
      ...
      _cache[2] || (_cache[2] = createBaseVNode("tr", null, [
        ...
        createBaseVNode("td", null, [
          createTextVNode("연동전표관리 "),
          createBaseVNode("br"),
          createTextVNode("(원료,자재,공사 등)")
        ]),
      ...
      createBaseVNode("tr", _hoisted_2, [
        ...
        createBaseVNode("td", _hoisted_3, [
          createVNode(_component_ClientOnly, null, {
            default: withCtx(() => [
              createVNode(_component_FI01figFlowChart)
            ]),
            _: 1
          })
        ])
...
const fig_flowchart = /*#__PURE__*/_export_sfc(_sfc_main, [['render',_sfc_render]]);

export { __pageData, fig_flowchart as default };
