...
const __pageData = JSON.parse("{\"title\":\"사전근태신청 플로우차트\",\"description\":\"\",\"frontmatter\":{},\"headers\":[],\"relativePath\":\"manual/manual_hr_02/hrt/hrt_flowchart2.md\",\"filePath\":\"manual/manual_hr_02/hrt/hrt_flowchart2.md\"}");
const _sfc_main = {name:"manual/manual_hr_02/hrt/hrt_flowchart2.md"};

const _hoisted_1 = { class: "no-stripe table-process" };
const _hoisted_2 = { style: {"height":"150px"} };
const _hoisted_3 = {
  colspan: "5",
  rowspan: "2",
  style: {"padding":"0"}
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  const _component_HR02hrtFlowChart2 = resolveComponent("HR02hrtFlowChart2");
  const _component_ClientOnly = resolveComponent("ClientOnly");

  return (openBlock(), createElementBlock("div", null, [
    _cache[5] || (_cache[5] = createBaseVNode("h1", {
      id: "사전근태신청-플로우차트",
      tabindex: "-1"
    }, [
      createTextVNode("사전근태신청 플로우차트 "),
      createBaseVNode("a", {
        class: "header-anchor",
        href: "#사전근태신청-플로우차트",
        "aria-label": "Permalink to \"사전근태신청 플로우차트\""
      }, "​")
    ], -1)),
    ...
    createBaseVNode("table", _hoisted_1, [
      ...
      _cache[2] || (_cache[2] = createBaseVNode("tr", null, [
        ...
        createBaseVNode("td", null, "사전근태신청"),
      ...
      createBaseVNode("tr", _hoisted_2, [
        ...
        createBaseVNode("td", _hoisted_3, [
          createVNode(_component_ClientOnly, null, {
            default: withCtx(() => [
              createVNode(_component_HR02hrtFlowChart2)
            ]),
            _: 1
          })
        ])
...
const hrt_flowchart2 = /*#__PURE__*/_export_sfc(_sfc_main, [['render',_sfc_render]]);

export { __pageData, hrt_flowchart2 as default };
