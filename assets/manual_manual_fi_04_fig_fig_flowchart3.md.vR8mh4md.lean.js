...
const __pageData = JSON.parse("{\"title\":\"개별재무제표관리 플로우차트\",\"description\":\"\",\"frontmatter\":{},\"headers\":[],\"relativePath\":\"manual/manual_fi_04/fig/fig_flowchart3.md\",\"filePath\":\"manual/manual_fi_04/fig/fig_flowchart3.md\"}");
const _sfc_main = {name:"manual/manual_fi_04/fig/fig_flowchart3.md"};
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  const _component_Fi04ComFlowChart_03 = resolveComponent("Fi04ComFlowChart_03");
  const _component_ClientOnly = resolveComponent("ClientOnly");

  return (openBlock(), createElementBlock("div", null, [
    _cache[4] || (_cache[4] = createBaseVNode("h1", {
      id: "개별재무제표관리-플로우차트",
      tabindex: "-1"
    }, [
      createTextVNode("개별재무제표관리 플로우차트 "),
      createBaseVNode("a", {
        class: "header-anchor",
        href: "#개별재무제표관리-플로우차트",
        "aria-label": "Permalink to \"개별재무제표관리 플로우차트\""
      }, "​")
    ], -1)),
    ...
    createBaseVNode("table", _hoisted_1, [
      ...
      _cache[2] || (_cache[2] = createBaseVNode("tr", null, [
        ...
        createBaseVNode("td", null, "개별 재무제표 관리"),
      ...
      createBaseVNode("tr", null, [
        ...
        createBaseVNode("td", _hoisted_2, [
          createVNode(_component_ClientOnly, null, {
            default: withCtx(() => [
              createVNode(_component_Fi04ComFlowChart_03)
            ]),
            _: 1
          })
        ])
