const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/chunks/dagre-6UL2VRFP.aIoyZ0YU.js","assets/chunks/graph.Cm8MpDdh.js","assets/chunks/baseUniq.D2oU2qmV.js","assets/chunks/layout.CiCkX5N_.js","assets/chunks/basePickBy.Chi-GGYW.js","assets/chunks/clone.CmKI3IVd.js","assets/chunks/cose-bilkent-S5V4N54A.D2KjvOWK.js","assets/chunks/cytoscape.esm.B7A0mjXA.js","assets/chunks/c4Diagram-YG6GDRKO.B3RxYjyY.js","assets/chunks/chunk-TZMSLE5B.DMiR1RYB.js","assets/chunks/flowDiagram-NV44I4VS.C2BlI1b-.js","assets/chunks/chunk-FMBD7UC4.DD32CR5H.js","assets/chunks/chunk-55IACEB6.CyIwnhpr.js","assets/chunks/chunk-QN33PNHL.C-qMRg7N.js","assets/chunks/channel.wSHvr7hv.js","assets/chunks/erDiagram-Q2GNP2WA.FAYLsn6N.js","assets/chunks/gitGraphDiagram-NY62KEGX.BZekhL0F.js","assets/chunks/chunk-4BX2VUAB.D5V_4Nwd.js","assets/chunks/chunk-QZHKN3VN.CYh9Zkyl.js","assets/chunks/treemap-KMMF4GRG.D5hi-bdQ.js","assets/chunks/framework.2vc7Ue4u.js","assets/chunks/ganttDiagram-JELNMOA3.CiC6AV-D.js","assets/chunks/linear.DwpPArp_.js","assets/chunks/init.zpY4DTin.js","assets/chunks/defaultLocale.BfO4jui1.js","assets/chunks/infoDiagram-WHAUD3N6.DR-ICde5.js","assets/chunks/pieDiagram-ADFJNKIX.D3OASHrY.js","assets/chunks/arc.B6W_K-4Z.js","assets/chunks/ordinal.DYf5Y5EM.js","assets/chunks/quadrantDiagram-AYHSOK5B.CBmWdDcD.js","assets/chunks/xychartDiagram-PRI3JC2R.cby0yj3T.js","assets/chunks/requirementDiagram-UZGBJVZJ.1joJS5dI.js","assets/chunks/sequenceDiagram-WL72ISMW.DPR1ozd4.js","assets/chunks/classDiagram-2ON5EDUG.BUC8MNnp.js","assets/chunks/chunk-B4BG7PRW.CyN3Xeaa.js","assets/chunks/classDiagram-v2-WZHVMYZB.BMiuNvf3.js","assets/chunks/stateDiagram-FKZM4ZOC.Cyi0KtkL.js","assets/chunks/chunk-DI55MBZ5.wFmksg8x.js","assets/chunks/stateDiagram-v2-4FDKWEC3.qxf5s3gW.js","assets/chunks/journeyDiagram-XKPGCS4Q.CnEaIDDD.js","assets/chunks/timeline-definition-IT6M3QCI.iBNRB643.js","assets/chunks/mindmap-definition-VGOIOE7T.BowaPe98.js","assets/chunks/kanban-definition-3W4ZIXB7.C-bSwZy8.js","assets/chunks/sankeyDiagram-TZEHDZUN.CMDuw6LE.js","assets/chunks/diagram-S2PKOQOG.1jQEx53m.js","assets/chunks/diagram-QEK2KX5R.C1BR-Yxu.js","assets/chunks/blockDiagram-VD42YOAC.BM3sxxFj.js","assets/chunks/architectureDiagram-VXUJARFQ.CnzQvJdQ.js","assets/chunks/diagram-PSM6KHXK.Btu6acs7.js"])))=>i.map(i=>d[i]);
import { ad as __vitePreload, h as ref, W as useData, aA as toRaw, m as onMounted, o as onUnmounted, c as createElementBlock, A as normalizeClass, a as openBlock, ab as inBrowser, aB as useUpdateHead, aC as RouterSymbol, aD as initData, ax as dataSymbol, aE as Content, aF as ClientOnly, aG as siteDataRef, aH as createRouter, ay as pathToFile, aI as createSSRApp, d as defineComponent, a1 as watchEffect, aJ as usePrefetch, aK as useCopyCode, aL as useCodeGroups, H as h$1 } from './chunks/framework.2vc7Ue4u.js';
import { R as RawTheme } from './chunks/theme.Cy7VYFsJ.js';
...
var renderKatexUnsanitized = /* @__PURE__ */ __name(async (text, config2) => {
  ...
  {
    const { default: katex } = await __vitePreload(async () => { const { default: katex } = await import('./chunks/katex.CnjCUzRs.js');return { default: katex }},true?[]:void 0);
...
`}strong({tokens:e}){return `<strong>${this.parser.parseInline(e)}</strong>`}em({tokens:e}){return `<em>${this.parser.parseInline(e)}</em>`}codespan({text:e}){return `<code>${w$1(e,true)}</code>`}br(e){return "<br>"}del({tokens:e}){return `<del>${this.parser.parseInline(e)}</del>`}link({href:e,title:t,tokens:n}){let r=this.parser.parseInline(n),i=J$1(e);if(i===null)return r;e=i;let s='<a href="'+e+'"';return t&&(s+=' title="'+w$1(t)+'"'),s+=">"+r+"</a>",s}image({href:e,title:t,text:n,tokens:r}){r&&(n=this.parser.parseInline(r,this.parser.textRenderer));let i=J$1(e);if(i===null)return w$1(n);e=i;let s=`<img src="${e}" alt="${n}"`;return t&&(s+=` title="${w$1(t)}"`),s+=">",s}text(e){return "tokens"in e&&e.tokens?this.parser.parseInline(e.tokens):"escaped"in e&&e.escaped?e.text:w$1(e.text)}};var $$1=class ${strong({text:e}){return e}em({text:e}){return e}codespan({text:e}){return e}del({text:e}){return e}html({text:e}){return e}text({text:e}){return e}link({text:e}){return ""+e}image({text:e}){return ""+e}br(){return ""}};var b$1=class l{options;renderer;textRenderer;constructor(e){this.options=e||T$1,this.options.renderer=this.options.renderer||new P$1,this.renderer=this.options.renderer,this.renderer.options=this.options,this.renderer.parser=this,this.textRenderer=new $$1;}static parse(e,t){return new l(t).parse(e)}static parseInline(e,t){return new l(t).parseInline(e)}parse(e,t=true){let n="";for(let r=0;r<e.length;r++){let i=e[r];if(this.options.extensions?.renderers?.[i.type]){let a=i,o=this.options.extensions.renderers[a.type].call({parser:this},a);if(o!==false||!["space","hr","heading","code","table","blockquote","list","html","def","paragraph","text"].includes(a.type)){n+=o||"";continue}}let s=i;switch(s.type){case "space":{n+=this.renderer.space(s);continue}case "hr":{n+=this.renderer.hr(s);continue}case "heading":{n+=this.renderer.heading(s);continue}case "code":{n+=this.renderer.code(s);continue}case "table":{n+=this.renderer.table(s);continue}case "blockquote":{n+=this.renderer.blockquote(s);continue}case "list":{n+=this.renderer.list(s);continue}case "html":{n+=this.renderer.html(s);continue}case "def":{n+=this.renderer.def(s);continue}case "paragraph":{n+=this.renderer.paragraph(s);continue}case "text":{let a=s,o=this.renderer.text(a);for(;r+1<e.length&&e[r+1].type==="text";)a=e[++r],o+=`
`+this.renderer.text(a);t?n+=this.renderer.paragraph({type:"paragraph",raw:o,text:o,tokens:[{type:"text",raw:o,text:o,escaped:true}]}):n+=o;continue}default:{let a='Token with "'+s.type+'" type was not found.';if(this.options.silent)return console.error(a),"";throw new Error(a)}}}return n}parseInline(e,t=this.renderer){let n="";for(let r=0;r<e.length;r++){let i=e[r];if(this.options.extensions?.renderers?.[i.type]){let a=this.options.extensions.renderers[i.type].call({parser:this},i);if(a!==false||!["escape","html","link","image","strong","em","codespan","br","del","text"].includes(i.type)){n+=a||"";continue}}let s=i;switch(s.type){case "escape":{n+=t.text(s);break}case "html":{n+=t.html(s);break}case "link":{n+=t.link(s);break}case "image":{n+=t.image(s);break}case "strong":{n+=t.strong(s);break}case "em":{n+=t.em(s);break}case "codespan":{n+=t.codespan(s);break}case "br":{n+=t.br(s);break}case "del":{n+=t.del(s);break}case "text":{n+=t.text(s);break}default:{let a='Token with "'+s.type+'" type was not found.';if(this.options.silent)return console.error(a),"";throw new Error(a)}}}return n}};var S$1=class S{options;block;constructor(e){this.options=e||T$1;}static passThroughHooks=new Set(["preprocess","postprocess","processAllTokens","emStrongMask"]);static passThroughHooksRespectAsync=new Set(["preprocess","postprocess","processAllTokens"]);preprocess(e){return e}postprocess(e){return e}processAllTokens(e){return e}emStrongMask(e){return e}provideLexer(){return this.block?x$1.lex:x$1.lexInline}provideParser(){return this.block?b$1.parse:b$1.parseInline}};var B$1=class B{defaults=L$1();options=this.setOptions;parse=this.parseMarkdown(true);parseInline=this.parseMarkdown(false);Parser=b$1;Renderer=P$1;TextRenderer=$$1;Lexer=x$1;Tokenizer=y$1;Hooks=S$1;constructor(...e){this.use(...e);}walkTokens(e,t){let n=[];for(let r of e)switch(n=n.concat(t.call(this,r)),r.type){case "table":{let i=r;for(let s of i.header)n=n.concat(this.walkTokens(s.tokens,t));for(let s of i.rows)for(let a of s)n=n.concat(this.walkTokens(a.tokens,t));break}case "list":{let i=r;n=n.concat(this.walkTokens(i.items,t));break}default:{let i=r;this.defaults.extensions?.childTokens?.[i.type]?this.defaults.extensions.childTokens[i.type].forEach(s=>{let a=i[s].flat(1/0);n=n.concat(this.walkTokens(a,t));}):i.tokens&&(n=n.concat(this.walkTokens(i.tokens,t)));}}return n}use(...e){let t=this.defaults.extensions||{renderers:{},childTokens:{}};return e.forEach(n=>{let r={...n};if(r.async=this.defaults.async||r.async||false,n.extensions&&(n.extensions.forEach(i=>{if(!i.name)throw new Error("extension name required");if("renderer"in i){let s=t.renderers[i.name];s?t.renderers[i.name]=function(...a){let o=i.renderer.apply(this,a);return o===false&&(o=s.apply(this,a)),o}:t.renderers[i.name]=i.renderer;}if("tokenizer"in i){if(!i.level||i.level!=="block"&&i.level!=="inline")throw new Error("extension level must be 'block' or 'inline'");let s=t[i.level];s?s.unshift(i.tokenizer):t[i.level]=[i.tokenizer],i.start&&(i.level==="block"?t.startBlock?t.startBlock.push(i.start):t.startBlock=[i.start]:i.level==="inline"&&(t.startInline?t.startInline.push(i.start):t.startInline=[i.start]));}"childTokens"in i&&i.childTokens&&(t.childTokens[i.name]=i.childTokens);}),r.extensions=t),n.renderer){let i=this.defaults.renderer||new P$1(this.defaults);for(let s in n.renderer){if(!(s in i))throw new Error(`renderer '${s}' does not exist`);if(["options","parser"].includes(s))continue;let a=s,o=n.renderer[a],p=i[a];i[a]=(...u)=>{let c=o.apply(i,u);return c===false&&(c=p.apply(i,u)),c||""};}r.renderer=i;}if(n.tokenizer){let i=this.defaults.tokenizer||new y$1(this.defaults);for(let s in n.tokenizer){if(!(s in i))throw new Error(`tokenizer '${s}' does not exist`);if(["options","rules","lexer"].includes(s))continue;let a=s,o=n.tokenizer[a],p=i[a];i[a]=(...u)=>{let c=o.apply(i,u);return c===false&&(c=p.apply(i,u)),c};}r.tokenizer=i;}if(n.hooks){let i=this.defaults.hooks||new S$1;for(let s in n.hooks){if(!(s in i))throw new Error(`hook '${s}' does not exist`);if(["options","block"].includes(s))continue;let a=s,o=n.hooks[a],p=i[a];S$1.passThroughHooks.has(s)?i[a]=u=>{if(this.defaults.async&&S$1.passThroughHooksRespectAsync.has(s))return (async()=>{let g=await o.call(i,u);return p.call(i,g)})();let c=o.call(i,u);return p.call(i,c)}:i[a]=(...u)=>{if(this.defaults.async)return (async()=>{let g=await o.apply(i,u);return g===false&&(g=await p.apply(i,u)),g})();let c=o.apply(i,u);return c===false&&(c=p.apply(i,u)),c};}r.hooks=i;}if(n.walkTokens){let i=this.defaults.walkTokens,s=n.walkTokens;r.walkTokens=function(a){let o=[];return o.push(s.call(this,a)),i&&(o=o.concat(i.call(this,a))),o};}this.defaults={...this.defaults,...r};}),this}setOptions(e){return this.defaults={...this.defaults,...e},this}lexer(e,t){return x$1.lex(e,t??this.defaults)}parser(e,t){return b$1.parse(e,t??this.defaults)}parseMarkdown(e){return (n,r)=>{let i={...r},s={...this.defaults,...i},a=this.onError(!!s.silent,!!s.async);if(this.defaults.async===true&&i.async===false)return a(new Error("marked(): The async option was set to true by an extension. Remove async: false from the parse options object to return a Promise."));if(typeof n>"u"||n===null)return a(new Error("marked(): input parameter is undefined or null"));if(typeof n!="string")return a(new Error("marked(): input parameter is of type "+Object.prototype.toString.call(n)+", string expected"));if(s.hooks&&(s.hooks.options=s,s.hooks.block=e),s.async)return (async()=>{let o=s.hooks?await s.hooks.preprocess(n):n,u=await(s.hooks?await s.hooks.provideLexer():e?x$1.lex:x$1.lexInline)(o,s),c=s.hooks?await s.hooks.processAllTokens(u):u;s.walkTokens&&await Promise.all(this.walkTokens(c,s.walkTokens));let h=await(s.hooks?await s.hooks.provideParser():e?b$1.parse:b$1.parseInline)(c,s);return s.hooks?await s.hooks.postprocess(h):h})().catch(a);try{s.hooks&&(n=s.hooks.preprocess(n));let p=(s.hooks?s.hooks.provideLexer():e?x$1.lex:x$1.lexInline)(n,s);s.hooks&&(p=s.hooks.processAllTokens(p)),s.walkTokens&&this.walkTokens(p,s.walkTokens);let c=(s.hooks?s.hooks.provideParser():e?b$1.parse:b$1.parseInline)(p,s);return s.hooks&&(c=s.hooks.postprocess(c)),c}catch(o){return a(o)}}}onError(e,t){return n=>{if(n.message+=`
Please report this to https://github.com/markedjs/marked.`,e){let r="<p>An error occurred:</p><pre>"+w$1(n.message+"",true)+"</pre>";return t?Promise.resolve(r):r}if(t)return Promise.reject(n);throw n}}};var _$1=new B$1;function k$1(l,e){return _$1.parse(l,e)}k$1.options=k$1.setOptions=function(l){return _$1.setOptions(l),k$1.defaults=_$1.defaults,G$1(k$1.defaults),k$1};k$1.getDefaults=L$1;k$1.defaults=T$1;k$1.use=function(...l){return _$1.use(...l),k$1.defaults=_$1.defaults,G$1(k$1.defaults),k$1};k$1.walkTokens=function(l,e){return _$1.walkTokens(l,e)};k$1.parseInline=_$1.parseInline;k$1.Parser=b$1;k$1.parser=b$1.parse;k$1.Renderer=P$1;k$1.TextRenderer=$$1;k$1.Lexer=x$1;k$1.lexer=x$1.lex;k$1.Tokenizer=y$1;k$1.Hooks=S$1;k$1.parse=k$1;k$1.options;k$1.setOptions;k$1.use;k$1.walkTokens;k$1.parseInline;b$1.parse;x$1.lex;
...
var registerDefaultLayoutLoaders = /* @__PURE__ */ __name(() => {
  registerLayoutLoaders([
    {
      name: "dagre",
      loader: /* @__PURE__ */ __name(async () => await __vitePreload(() => import('./chunks/dagre-6UL2VRFP.aIoyZ0YU.js'),true?__vite__mapDeps([0,1,2,3,4,5]):void 0), "loader")
    },
    ...[
      {
        name: "cose-bilkent",
        loader: /* @__PURE__ */ __name(async () => await __vitePreload(() => import('./chunks/cose-bilkent-S5V4N54A.D2KjvOWK.js'),true?__vite__mapDeps([6,7]):void 0), "loader")
      }
    ] 
  ]);
}, "registerDefaultLayoutLoaders");
registerDefaultLayoutLoaders();
var render$2 = /* @__PURE__ */ __name(async (data4Layout, svg) => {
...
var loader = /* @__PURE__ */ __name(async () => {
  const { diagram: diagram2 } = await __vitePreload(async () => { const { diagram: diagram2 } = await import('./chunks/c4Diagram-YG6GDRKO.B3RxYjyY.js');return { diagram: diagram2 }},true?__vite__mapDeps([8,9]):void 0);
...
var loader2 = /* @__PURE__ */ __name(async () => {
  const { diagram: diagram2 } = await __vitePreload(async () => { const { diagram: diagram2 } = await import('./chunks/flowDiagram-NV44I4VS.C2BlI1b-.js');return { diagram: diagram2 }},true?__vite__mapDeps([10,11,12,13,14]):void 0);
...
var loader4 = /* @__PURE__ */ __name(async () => {
  const { diagram: diagram2 } = await __vitePreload(async () => { const { diagram: diagram2 } = await import('./chunks/erDiagram-Q2GNP2WA.FAYLsn6N.js');return { diagram: diagram2 }},true?__vite__mapDeps([15,12,13,14]):void 0);
...
var loader5 = /* @__PURE__ */ __name(async () => {
  const { diagram: diagram2 } = await __vitePreload(async () => { const { diagram: diagram2 } = await import('./chunks/gitGraphDiagram-NY62KEGX.BZekhL0F.js');return { diagram: diagram2 }},true?__vite__mapDeps([16,17,18,19,20,2,4,5]):void 0);
...
var loader6 = /* @__PURE__ */ __name(async () => {
  const { diagram: diagram2 } = await __vitePreload(async () => { const { diagram: diagram2 } = await import('./chunks/ganttDiagram-JELNMOA3.CiC6AV-D.js');return { diagram: diagram2 }},true?__vite__mapDeps([21,22,23,24]):void 0);
...
var loader7 = /* @__PURE__ */ __name(async () => {
  const { diagram: diagram2 } = await __vitePreload(async () => { const { diagram: diagram2 } = await import('./chunks/infoDiagram-WHAUD3N6.DR-ICde5.js');return { diagram: diagram2 }},true?__vite__mapDeps([25,19,20,2,4,5]):void 0);
...
var loader8 = /* @__PURE__ */ __name(async () => {
  const { diagram: diagram2 } = await __vitePreload(async () => { const { diagram: diagram2 } = await import('./chunks/pieDiagram-ADFJNKIX.D3OASHrY.js');return { diagram: diagram2 }},true?__vite__mapDeps([26,17,19,20,2,4,5,27,28,23]):void 0);
...
var loader9 = /* @__PURE__ */ __name(async () => {
  const { diagram: diagram2 } = await __vitePreload(async () => { const { diagram: diagram2 } = await import('./chunks/quadrantDiagram-AYHSOK5B.CBmWdDcD.js');return { diagram: diagram2 }},true?__vite__mapDeps([29,22,23,24]):void 0);
...
var loader10 = /* @__PURE__ */ __name(async () => {
  const { diagram: diagram2 } = await __vitePreload(async () => { const { diagram: diagram2 } = await import('./chunks/xychartDiagram-PRI3JC2R.cby0yj3T.js');return { diagram: diagram2 }},true?__vite__mapDeps([30,23,28,22,24]):void 0);
...
var loader11 = /* @__PURE__ */ __name(async () => {
  const { diagram: diagram2 } = await __vitePreload(async () => { const { diagram: diagram2 } = await import('./chunks/requirementDiagram-UZGBJVZJ.1joJS5dI.js');return { diagram: diagram2 }},true?__vite__mapDeps([31,12,13]):void 0);
...
var loader12 = /* @__PURE__ */ __name(async () => {
  const { diagram: diagram2 } = await __vitePreload(async () => { const { diagram: diagram2 } = await import('./chunks/sequenceDiagram-WL72ISMW.DPR1ozd4.js');return { diagram: diagram2 }},true?__vite__mapDeps([32,9,18]):void 0);
...
var loader13 = /* @__PURE__ */ __name(async () => {
  const { diagram: diagram2 } = await __vitePreload(async () => { const { diagram: diagram2 } = await import('./chunks/classDiagram-2ON5EDUG.BUC8MNnp.js');return { diagram: diagram2 }},true?__vite__mapDeps([33,34,11,12,13]):void 0);
...
var loader14 = /* @__PURE__ */ __name(async () => {
  const { diagram: diagram2 } = await __vitePreload(async () => { const { diagram: diagram2 } = await import('./chunks/classDiagram-v2-WZHVMYZB.BMiuNvf3.js');return { diagram: diagram2 }},true?__vite__mapDeps([35,34,11,12,13]):void 0);
...
var loader15 = /* @__PURE__ */ __name(async () => {
  const { diagram: diagram2 } = await __vitePreload(async () => { const { diagram: diagram2 } = await import('./chunks/stateDiagram-FKZM4ZOC.Cyi0KtkL.js');return { diagram: diagram2 }},true?__vite__mapDeps([36,37,12,13,1,2,3,4]):void 0);
...
var loader16 = /* @__PURE__ */ __name(async () => {
  const { diagram: diagram2 } = await __vitePreload(async () => { const { diagram: diagram2 } = await import('./chunks/stateDiagram-v2-4FDKWEC3.qxf5s3gW.js');return { diagram: diagram2 }},true?__vite__mapDeps([38,37,12,13]):void 0);
...
var loader17 = /* @__PURE__ */ __name(async () => {
  const { diagram: diagram2 } = await __vitePreload(async () => { const { diagram: diagram2 } = await import('./chunks/journeyDiagram-XKPGCS4Q.CnEaIDDD.js');return { diagram: diagram2 }},true?__vite__mapDeps([39,9,11,27]):void 0);
...
var loader19 = /* @__PURE__ */ __name(async () => {
  const { diagram: diagram2 } = await __vitePreload(async () => { const { diagram: diagram2 } = await import('./chunks/timeline-definition-IT6M3QCI.iBNRB643.js');return { diagram: diagram2 }},true?__vite__mapDeps([40,27]):void 0);
...
var loader20 = /* @__PURE__ */ __name(async () => {
  const { diagram: diagram2 } = await __vitePreload(async () => { const { diagram: diagram2 } = await import('./chunks/mindmap-definition-VGOIOE7T.BowaPe98.js');return { diagram: diagram2 }},true?__vite__mapDeps([41,12,13]):void 0);
...
var loader21 = /* @__PURE__ */ __name(async () => {
  const { diagram: diagram2 } = await __vitePreload(async () => { const { diagram: diagram2 } = await import('./chunks/kanban-definition-3W4ZIXB7.C-bSwZy8.js');return { diagram: diagram2 }},true?__vite__mapDeps([42,11]):void 0);
...
var loader22 = /* @__PURE__ */ __name(async () => {
  const { diagram: diagram2 } = await __vitePreload(async () => { const { diagram: diagram2 } = await import('./chunks/sankeyDiagram-TZEHDZUN.CMDuw6LE.js');return { diagram: diagram2 }},true?__vite__mapDeps([43,28,23]):void 0);
...
var loader23 = /* @__PURE__ */ __name(async () => {
  const { diagram: diagram2 } = await __vitePreload(async () => { const { diagram: diagram2 } = await import('./chunks/diagram-S2PKOQOG.1jQEx53m.js');return { diagram: diagram2 }},true?__vite__mapDeps([44,17,19,20,2,4,5]):void 0);
...
var loader24 = /* @__PURE__ */ __name(async () => {
  const { diagram: diagram2 } = await __vitePreload(async () => { const { diagram: diagram2 } = await import('./chunks/diagram-QEK2KX5R.C1BR-Yxu.js');return { diagram: diagram2 }},true?__vite__mapDeps([45,17,19,20,2,4,5]):void 0);
...
var loader25 = /* @__PURE__ */ __name(async () => {
  const { diagram: diagram2 } = await __vitePreload(async () => { const { diagram: diagram2 } = await import('./chunks/blockDiagram-VD42YOAC.BM3sxxFj.js');return { diagram: diagram2 }},true?__vite__mapDeps([46,11,5,2,1,14]):void 0);
...
var loader26 = /* @__PURE__ */ __name(async () => {
  const { diagram: diagram2 } = await __vitePreload(async () => { const { diagram: diagram2 } = await import('./chunks/architectureDiagram-VXUJARFQ.CnzQvJdQ.js');return { diagram: diagram2 }},true?__vite__mapDeps([47,17,19,20,2,4,5,7]):void 0);
...
var loader27 = /* @__PURE__ */ __name(async () => {
  const { diagram: diagram2 } = await __vitePreload(async () => { const { diagram: diagram2 } = await import('./chunks/diagram-PSM6KHXK.Btu6acs7.js');return { diagram: diagram2 }},true?__vite__mapDeps([48,13,17,19,20,2,4,5,24,28,23]):void 0);
...
var render$1 = /* @__PURE__ */ __name(async function(id28, text, svgContainingElement) {
  addDiagrams();
...
var init$1 = /* @__PURE__ */ __name(async function(config, nodes, callback) {
...
onMounted(async () => {
  ...
  let settings = await __vitePreload(() => import('./chunks/virtual_mermaid-config.DnC7avZU.js'),true?[]:void 0);
...
export { acos as $, defaultConfig2 as A, rgba$1 as B, Color$1 as C, __export as D, setupGraphViewbox2 as E, cleanAndMerge as F, getConfig as G, defaultConfig_default as H, random as I, JSON_SCHEMA as J, selectSvgElement as K, package_default as L, withPath as M, halfPi as N, epsilon as O, tau as P, cos as Q, sin as R, min as S, abs$1 as T, Utils as U, constant$1 as V, pi as W, sqrt as X, atan2 as Y, asin as Z, __name as _, getAccTitle as a, styles2String as a$, max as a0, getThemeVariables3 as a1, hasKatex as a2, calculateMathMLDimensions as a3, parseFontSize as a4, ZERO_WIDTH_SPACE as a5, getUrl as a6, renderKatexSanitized as a7, parseGenericTypes as a8, line$1 as a9, updateNodeBounds as aA, setNodeElem as aB, insertEdge as aC, positionEdgeLabel as aD, insertEdgeLabel as aE, computeDimensionOfText as aF, array as aG, getUserDefinedConfig as aH, commonjsGlobal as aI, getDefaultExportFromCjs as aJ, getIconSVG as aK, registerIconPacks as aL, unknownIcon as aM, isObject as aN, isIterateeCall as aO, keysIn as aP, eq as aQ, isArrayLike as aR, isArray as aS, identity as aT, isIndex as aU, assignValue as aV, constant$2 as aW, interpolateNumber as aX, interpolateRgb as aY, interpolateString as aZ, color as a_, curveBasis as aa, generateId as ab, setupGraphViewbox as ac, isDark as ad, lighten as ae, darken as af, commonDb_exports as ag, insertCluster as ah, insertNode as ai, positionNode as aj, getLineFunctionsWithOffset as ak, evaluate as al, createText as am, getSubGraphTitleMargins as an, replaceIconSubstring as ao, decodeEntities as ap, getStylesFromArray as aq, baseRest as ar, isArrayLikeObject as as, constant as at, isFunction as au, isEmpty as av, markers_default as aw, clear2 as ax, clear as ay, clear$1 as az, setAccTitle as b, isLabelStyle as b0, Rgb as b1, rgbConvert as b2, define as b3, extend$1 as b4, Color as b5, nogamma as b6, hue as b7, dayjs2 as b8, setToString as b9, isLength as bA, Set$1 as bB, createAssigner as bC, isPrototype as bD, overRest as ba, baseFor as bb, baseAssignValue as bc, baseUnary as bd, merge as be, isObjectLike as bf, baseGetTag as bg, Symbol$1 as bh, arrayLikeKeys as bi, baseKeys as bj, memoize as bk, isArguments as bl, copyObject as bm, getPrototype as bn, cloneArrayBuffer as bo, cloneTypedArray as bp, getTag as bq, nodeUtil as br, copyArray as bs, isBuffer as bt, cloneBuffer as bu, initCloneObject as bv, Stack as bw, MapCache as bx, Uint8Array$1 as by, isTypedArray as bz, getConfig2 as c, createApp, select as d, configureSvgSize as e, assignWithDepth_default as f, getAccDescription as g, calculateTextWidth as h, sanitizeText as i, sanitizeUrl_1 as j, common_default as k, log as l, calculateTextHeight as m, lineBreakRegex as n, setConfig2 as o, getRegisteredLayoutAlgorithm as p, setDiagramTitle as q, render$2 as r, setAccDescription as s, getDiagramTitle as t, utils_default as u, load as v, wrapLabel as w, isValidShape as x, getEdgeId as y, clear$2 as z };
