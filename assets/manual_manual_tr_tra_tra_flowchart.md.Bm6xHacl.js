...
const __pageData = JSON.parse("{\"title\":\"자금집행 입금관리 플로우차트\",\"description\":\"\",\"frontmatter\":{},\"headers\":[],\"relativePath\":\"manual/manual_tr/tra/tra_flowchart.md\",\"filePath\":\"manual/manual_tr/tra/tra_flowchart.md\"}");
const _sfc_main = {name:"manual/manual_tr/tra/tra_flowchart.md"};

const _hoisted_1 = { class: "no-stripe table-process" };
const _hoisted_2 = { style: {"height":"350px"} };
const _hoisted_3 = {
  colspan: "5",
  rowspan: "2",
  style: {"padding":"0"}
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  const _component_TrTraFlowChart = resolveComponent("TrTraFlowChart");
  const _component_ClientOnly = resolveComponent("ClientOnly");

  return (openBlock(), createElementBlock("div", null, [
    _cache[5] || (_cache[5] = createBaseVNode("h1", {
      id: "자금집행-입금관리-플로우차트",
      tabindex: "-1"
    }, [
      createTextVNode("자금집행 입금관리 플로우차트 "),
      createBaseVNode("a", {
        class: "header-anchor",
        href: "#자금집행-입금관리-플로우차트",
        "aria-label": "Permalink to \"자금집행 입금관리 플로우차트\""
      }, "​")
    ], -1)),
    ...
    createBaseVNode("table", _hoisted_1, [
      ...
      _cache[2] || (_cache[2] = createBaseVNode("tr", null, [
        ...
        createBaseVNode("td", null, "자금집행"),
        createBaseVNode("th", null, "Task"),
        createBaseVNode("td", null, "입금관리"),
      ...
      createBaseVNode("tr", _hoisted_2, [
        _cache[0] || (_cache[0] = createBaseVNode("td", null, "자금담당", -1)),
        createBaseVNode("td", _hoisted_3, [
          createVNode(_component_ClientOnly, null, {
            default: withCtx(() => [
              createVNode(_component_TrTraFlowChart)
            ]),
            _: 1
          })
        ])
      ...
      _cache[4] || (_cache[4] = createBaseVNode("tr", null, [
        createBaseVNode("td", null, "영업담당")
      ], -1))
    ])
  ]))
}
const tra_flowchart = /*#__PURE__*/_export_sfc(_sfc_main, [['render',_sfc_render]]);

export { __pageData, tra_flowchart as default };
