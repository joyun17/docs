...
const __pageData = JSON.parse("{\"title\":\"인사시스템 구조\",\"description\":\"\",\"frontmatter\":{},\"headers\":[],\"relativePath\":\"manual/manual_common/02-hr-system-structure.md\",\"filePath\":\"manual/manual_common/02-hr-system-structure.md\"}");
const _sfc_main = {name:"manual/manual_common/02-hr-system-structure.md"};
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return (openBlock(), createElementBlock("div", null, [
    _cache[0] || (_cache[0] = createStaticVNode("<h1 id=\"인사시스템-구조\" tabindex=\"-1\">인사시스템 구조 <a class=\"header-anchor\" href=\"#인사시스템-구조\" aria-label=\"Permalink to &quot;인사시스템 구조&quot;\">​</a></h1><h2 id=\"개요\" tabindex=\"-1\">개요 <a class=\"header-anchor\" href=\"#개요\" aria-label=\"Permalink to &quot;개요&quot;\">​</a></h2><p><strong>ESS/인사 시스템 통합 구축</strong>으로 인사 업무 사용자 만족도를 제고하고, <strong>FCM(회계, 원가), SCM</strong>과 연동하여 통합적인 인사 관리가 가능합니다.</p><h3 id=\"인사-시스템\" tabindex=\"-1\">인사 시스템 <a class=\"header-anchor\" href=\"#인사-시스템\" aria-label=\"Permalink to &quot;인사 시스템&quot;\">​</a></h3>", 4)),
