...
const __pageData = JSON.parse("{\"title\":\"발령관리 플로우차트\",\"description\":\"\",\"frontmatter\":{},\"headers\":[],\"relativePath\":\"manual/manual_hr_01/hri/hri_flowchart2.md\",\"filePath\":\"manual/manual_hr_01/hri/hri_flowchart2.md\"}");
const _sfc_main = {name:"manual/manual_hr_01/hri/hri_flowchart2.md"};
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  const _component_HR01hriFlowChart2 = resolveComponent("HR01hriFlowChart2");
  const _component_ClientOnly = resolveComponent("ClientOnly");

  return (openBlock(), createElementBlock("div", null, [
    _cache[4] || (_cache[4] = createBaseVNode("h1", {
      id: "발령관리-플로우차트",
      tabindex: "-1"
    }, [
      createTextVNode("발령관리 플로우차트 "),
      createBaseVNode("a", {
        class: "header-anchor",
        href: "#발령관리-플로우차트",
        "aria-label": "Permalink to \"발령관리 플로우차트\""
      }, "​")
    ], -1)),
      ...
      createBaseVNode("tr", null, [
        ...
        createBaseVNode("td", _hoisted_2, [
          createVNode(_component_ClientOnly, null, {
            default: withCtx(() => [
              createVNode(_component_HR01hriFlowChart2)
            ]),
            _: 1
          })
        ])
...
const hri_flowchart2 = /*#__PURE__*/_export_sfc(_sfc_main, [['render',_sfc_render]]);

export { __pageData, hri_flowchart2 as default };
