...
const __pageData = JSON.parse("{\"title\":\"교육 실적 관리 플로우차트\",\"description\":\"\",\"frontmatter\":{},\"headers\":[],\"relativePath\":\"manual/manual_hr_06/hre/hre_flowchart2.md\",\"filePath\":\"manual/manual_hr_06/hre/hre_flowchart2.md\"}");
const _sfc_main = {name:"manual/manual_hr_06/hre/hre_flowchart2.md"};
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  const _component_Hr06HreFlowChart2 = resolveComponent("Hr06HreFlowChart2");
  const _component_ClientOnly = resolveComponent("ClientOnly");

  return (openBlock(), createElementBlock("div", null, [
    _cache[6] || (_cache[6] = createBaseVNode("h1", {
      id: "교육-실적-관리-플로우차트",
      tabindex: "-1"
    }, [
      createTextVNode("교육 실적 관리 플로우차트 "),
      createBaseVNode("a", {
        class: "header-anchor",
        href: "#교육-실적-관리-플로우차트",
        "aria-label": "Permalink to \"교육 실적 관리 플로우차트\""
      }, "​")
    ], -1)),
    ...
    createBaseVNode("table", _hoisted_1, [
      ...
      _cache[2] || (_cache[2] = createBaseVNode("tr", null, [
        ...
        createBaseVNode("td", null, "교육관리"),
        createBaseVNode("th", null, "Task"),
        createBaseVNode("td", null, "교육 실적 관리"),
      ...
      createBaseVNode("tr", _hoisted_2, [
        _cache[0] || (_cache[0] = createBaseVNode("td", null, "외부업체", -1)),
        createBaseVNode("td", _hoisted_3, [
          createVNode(_component_ClientOnly, null, {
            default: withCtx(() => [
              createVNode(_component_Hr06HreFlowChart2)
            ]),
            _: 1
          })
        ])
      ...
      _cache[4] || (_cache[4] = createBaseVNode("tr", { style: {"height":"200px"} }, [
        createBaseVNode("td", { style: {"padding":"0"} }, "인사총무팀")
      ], -1)),
      _cache[5] || (_cache[5] = createBaseVNode("tr", { style: {"height":"200px"} }, [
        createBaseVNode("td", null, "직원")
      ], -1))
    ])
  ]))
}
const hre_flowchart2 = /*#__PURE__*/_export_sfc(_sfc_main, [['render',_sfc_render]]);

export { __pageData, hre_flowchart2 as default };
