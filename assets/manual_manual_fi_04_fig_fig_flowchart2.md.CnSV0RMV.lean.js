...
const __pageData = JSON.parse("{\"title\":\"원장관리 플로우차트\",\"description\":\"\",\"frontmatter\":{},\"headers\":[],\"relativePath\":\"manual/manual_fi_04/fig/fig_flowchart2.md\",\"filePath\":\"manual/manual_fi_04/fig/fig_flowchart2.md\"}");
const _sfc_main = {name:"manual/manual_fi_04/fig/fig_flowchart2.md"};
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  const _component_Fi04ComFlowChart_02 = resolveComponent("Fi04ComFlowChart_02");
  const _component_ClientOnly = resolveComponent("ClientOnly");

  return (openBlock(), createElementBlock("div", null, [
    _cache[4] || (_cache[4] = createBaseVNode("h1", {
      id: "원장관리-플로우차트",
      tabindex: "-1"
    }, [
      createTextVNode("원장관리 플로우차트 "),
      createBaseVNode("a", {
        class: "header-anchor",
        href: "#원장관리-플로우차트",
        "aria-label": "Permalink to \"원장관리 플로우차트\""
      }, "​")
    ], -1)),
      ...
      createBaseVNode("tr", null, [
        ...
        createBaseVNode("td", _hoisted_2, [
          createVNode(_component_ClientOnly, null, {
            default: withCtx(() => [
              createVNode(_component_Fi04ComFlowChart_02)
            ]),
            _: 1
          })
        ])
...
const fig_flowchart2 = /*#__PURE__*/_export_sfc(_sfc_main, [['render',_sfc_render]]);

export { __pageData, fig_flowchart2 as default };
