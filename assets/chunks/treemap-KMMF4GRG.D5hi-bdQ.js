import { ad as __vitePreload } from './framework.2vc7Ue4u.js';
import { bC as createAssigner, bD as isPrototype, aR as isArrayLike, bm as copyObject, aV as assignValue, aS as isArray, ar as baseRest, as as isArrayLikeObject, bc as baseAssignValue, bf as isObjectLike, bg as baseGetTag, bd as baseUnary, br as nodeUtil, au as isFunction, av as isEmpty, aT as identity, aN as isObject } from '../app.KsIAalK8.js';
import { k as keys, j as baseEach, g as baseIteratee, S as SetCache, w as arrayIncludes, x as cacheHas, c as baseFlatten, v as values, y as baseIndexOf, l as arrayMap, z as getAllKeysIn, A as arrayFilter, B as baseFilter, C as arraySome, a as baseUniq, d as forEach, i as isUndefined, r as reduce, f as filter, D as noop } from './baseUniq.D2oU2qmV.js';
import { j as toInteger, m as map, d as basePickBy, f as flatten, g as find, h as has, i as defaults, l as last, e as min } from './basePickBy.Chi-GGYW.js';
import { c as clone } from './clone.CmKI3IVd.js';
...
var initializers = {
  info: /* @__PURE__ */ __name(async () => {
    const { createInfoServices: createInfoServices2 } = await __vitePreload(async () => { const { createInfoServices: createInfoServices2 } = await Promise.resolve().then(() => infoNVLQJR56);return { createInfoServices: createInfoServices2 }},true?void 0:void 0);
    const parser = createInfoServices2().Info.parser.LangiumParser;
    parsers.info = parser;
  }, "info"),
  packet: /* @__PURE__ */ __name(async () => {
    const { createPacketServices: createPacketServices2 } = await __vitePreload(async () => { const { createPacketServices: createPacketServices2 } = await Promise.resolve().then(() => packetBFZMPI3H);return { createPacketServices: createPacketServices2 }},true?void 0:void 0);
    const parser = createPacketServices2().Packet.parser.LangiumParser;
    parsers.packet = parser;
  }, "packet"),
  pie: /* @__PURE__ */ __name(async () => {
    const { createPieServices: createPieServices2 } = await __vitePreload(async () => { const { createPieServices: createPieServices2 } = await Promise.resolve().then(() => pie7BOR55EZ);return { createPieServices: createPieServices2 }},true?void 0:void 0);
    const parser = createPieServices2().Pie.parser.LangiumParser;
    parsers.pie = parser;
  }, "pie"),
  architecture: /* @__PURE__ */ __name(async () => {
    const { createArchitectureServices: createArchitectureServices2 } = await __vitePreload(async () => { const { createArchitectureServices: createArchitectureServices2 } = await Promise.resolve().then(() => architectureU656AL7Q);return { createArchitectureServices: createArchitectureServices2 }},true?void 0:void 0);
    const parser = createArchitectureServices2().Architecture.parser.LangiumParser;
    parsers.architecture = parser;
  }, "architecture"),
  gitGraph: /* @__PURE__ */ __name(async () => {
    const { createGitGraphServices: createGitGraphServices2 } = await __vitePreload(async () => { const { createGitGraphServices: createGitGraphServices2 } = await Promise.resolve().then(() => gitGraphF6HP7TQM);return { createGitGraphServices: createGitGraphServices2 }},true?void 0:void 0);
    const parser = createGitGraphServices2().GitGraph.parser.LangiumParser;
    parsers.gitGraph = parser;
  }, "gitGraph"),
  radar: /* @__PURE__ */ __name(async () => {
    const { createRadarServices: createRadarServices2 } = await __vitePreload(async () => { const { createRadarServices: createRadarServices2 } = await Promise.resolve().then(() => radarNHE76QYJ);return { createRadarServices: createRadarServices2 }},true?void 0:void 0);
    const parser = createRadarServices2().Radar.parser.LangiumParser;
    parsers.radar = parser;
  }, "radar"),
  treemap: /* @__PURE__ */ __name(async () => {
    const { createTreemapServices: createTreemapServices2 } = await __vitePreload(async () => { const { createTreemapServices: createTreemapServices2 } = await Promise.resolve().then(() => treemapKMMF4GRG);return { createTreemapServices: createTreemapServices2 }},true?void 0:void 0);
