...
const __pageData = JSON.parse("{\"title\":\"자금운용 플로우차트\",\"description\":\"\",\"frontmatter\":{},\"headers\":[],\"relativePath\":\"manual/manual_tr/trd/trd_flowchart.md\",\"filePath\":\"manual/manual_tr/trd/trd_flowchart.md\"}");
const _sfc_main = {name:"manual/manual_tr/trd/trd_flowchart.md"};
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  const _component_TrTrdFlowChart = resolveComponent("TrTrdFlowChart");
  const _component_ClientOnly = resolveComponent("ClientOnly");

  return (openBlock(), createElementBlock("div", null, [
    _cache[4] || (_cache[4] = createBaseVNode("h1", {
      id: "자금운용-플로우차트",
      tabindex: "-1"
    }, [
      createTextVNode("자금운용 플로우차트 "),
      createBaseVNode("a", {
        class: "header-anchor",
        href: "#자금운용-플로우차트",
        "aria-label": "Permalink to \"자금운용 플로우차트\""
      }, "​")
    ], -1)),
    ...
    createBaseVNode("table", _hoisted_1, [
      ...
      _cache[2] || (_cache[2] = createBaseVNode("tr", null, [
        ...
        createBaseVNode("td", null, "자금운용"),
        createBaseVNode("th", null, "Task"),
        createBaseVNode("td", null, "예적금관리"),
      ...
      createBaseVNode("tr", null, [
        ...
        createBaseVNode("td", _hoisted_2, [
          createVNode(_component_ClientOnly, null, {
            default: withCtx(() => [
              createVNode(_component_TrTrdFlowChart)
            ]),
            _: 1
          })
        ])
...
const trd_flowchart = /*#__PURE__*/_export_sfc(_sfc_main, [['render',_sfc_render]]);

export { __pageData, trd_flowchart as default };
