...
const __pageData = JSON.parse("{\"title\":\"부가세 관리 플로우차트\",\"description\":\"\",\"frontmatter\":{},\"headers\":[],\"relativePath\":\"manual/manual_fi_05/fit/fit_flowchart1.md\",\"filePath\":\"manual/manual_fi_05/fit/fit_flowchart1.md\"}");
const _sfc_main = {name:"manual/manual_fi_05/fit/fit_flowchart1.md"};
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  const _component_FI05fitFlowChart1 = resolveComponent("FI05fitFlowChart1");
  const _component_ClientOnly = resolveComponent("ClientOnly");

  return (openBlock(), createElementBlock("div", null, [
    _cache[4] || (_cache[4] = createBaseVNode("h1", {
      id: "부가세-관리-플로우차트",
      tabindex: "-1"
    }, [
      createTextVNode("부가세 관리 플로우차트 "),
      createBaseVNode("a", {
        class: "header-anchor",
        href: "#부가세-관리-플로우차트",
        "aria-label": "Permalink to \"부가세 관리 플로우차트\""
      }, "​")
    ], -1)),
    ...
    createBaseVNode("table", _hoisted_1, [
      ...
      _cache[2] || (_cache[2] = createBaseVNode("tr", null, [
        ...
        createBaseVNode("td", null, "세무관리"),
        createBaseVNode("th", null, "Task"),
        createBaseVNode("td", null, "부가세 관리"),
      ...
      createBaseVNode("tr", null, [
        ...
        createBaseVNode("td", _hoisted_2, [
          createVNode(_component_ClientOnly, null, {
            default: withCtx(() => [
              createVNode(_component_FI05fitFlowChart1)
            ]),
            _: 1
          })
        ])
...
const fit_flowchart1 = /*#__PURE__*/_export_sfc(_sfc_main, [['render',_sfc_render]]);

export { __pageData, fit_flowchart1 as default };
