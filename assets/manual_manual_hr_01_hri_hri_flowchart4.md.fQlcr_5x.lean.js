...
const __pageData = JSON.parse("{\"title\":\"통계/현황관리 플로우차트\",\"description\":\"\",\"frontmatter\":{},\"headers\":[],\"relativePath\":\"manual/manual_hr_01/hri/hri_flowchart4.md\",\"filePath\":\"manual/manual_hr_01/hri/hri_flowchart4.md\"}");
const _sfc_main = {name:"manual/manual_hr_01/hri/hri_flowchart4.md"};
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  const _component_HR01hriFlowChart4 = resolveComponent("HR01hriFlowChart4");
  const _component_ClientOnly = resolveComponent("ClientOnly");

  return (openBlock(), createElementBlock("div", null, [
    _cache[5] || (_cache[5] = createBaseVNode("h1", {
      id: "통계-현황관리-플로우차트",
      tabindex: "-1"
    }, [
      createTextVNode("통계/현황관리 플로우차트 "),
      createBaseVNode("a", {
        class: "header-anchor",
        href: "#통계-현황관리-플로우차트",
        "aria-label": "Permalink to \"통계/현황관리 플로우차트\""
      }, "​")
    ], -1)),
    ...
    createBaseVNode("table", _hoisted_1, [
      ...
      _cache[2] || (_cache[2] = createBaseVNode("tr", null, [
        ...
        createBaseVNode("td", null, "통계/현황관리"),
      ...
      createBaseVNode("tr", _hoisted_2, [
        ...
        createBaseVNode("td", _hoisted_3, [
          createVNode(_component_ClientOnly, null, {
            default: withCtx(() => [
              createVNode(_component_HR01hriFlowChart4)
            ]),
            _: 1
          })
        ])
...
const hri_flowchart4 = /*#__PURE__*/_export_sfc(_sfc_main, [['render',_sfc_render]]);

export { __pageData, hri_flowchart4 as default };
