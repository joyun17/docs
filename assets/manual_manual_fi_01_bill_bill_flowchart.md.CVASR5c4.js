...
const __pageData = JSON.parse("{\"title\":\"법인카드전표 관리 플로우차트\",\"description\":\"\",\"frontmatter\":{},\"headers\":[],\"relativePath\":\"manual/manual_fi_01/bill/bill_flowchart.md\",\"filePath\":\"manual/manual_fi_01/bill/bill_flowchart.md\"}");
const _sfc_main = {name:"manual/manual_fi_01/bill/bill_flowchart.md"};

const _hoisted_1 = { class: "no-stripe table-process" };
const _hoisted_2 = { style: {"height":"30px"} };
const _hoisted_3 = {
  colspan: "5",
  rowspan: "3",
  style: {"padding":"0"}
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  const _component_FI01billFlowChart = resolveComponent("FI01billFlowChart");
  const _component_ClientOnly = resolveComponent("ClientOnly");

  return (openBlock(), createElementBlock("div", null, [
    _cache[6] || (_cache[6] = createBaseVNode("h1", {
      id: "법인카드전표-관리-플로우차트",
      tabindex: "-1"
    }, [
      createTextVNode("법인카드전표 관리 플로우차트 "),
      createBaseVNode("a", {
        class: "header-anchor",
        href: "#법인카드전표-관리-플로우차트",
        "aria-label": "Permalink to \"법인카드전표 관리 플로우차트\""
      }, "​")
    ], -1)),
    ...
    createBaseVNode("table", _hoisted_1, [
      ...
      _cache[2] || (_cache[2] = createBaseVNode("tr", null, [
        ...
        createBaseVNode("td", null, "법인카드전표관리"),
      ...
      createBaseVNode("tr", _hoisted_2, [
        _cache[0] || (_cache[0] = createBaseVNode("td", null, "법인카드", -1)),
        createBaseVNode("td", _hoisted_3, [
          createVNode(_component_ClientOnly, null, {
            default: withCtx(() => [
              createVNode(_component_FI01billFlowChart)
            ]),
            _: 1
          })
        ])
      ]),
      _cache[4] || (_cache[4] = createBaseVNode("tr", { style: {"height":"170px"} }, [
        createBaseVNode("td", null, "회계")
      ], -1)),
      _cache[5] || (_cache[5] = createBaseVNode("tr", { style: {"height":"170px"} }, [
        createBaseVNode("td", null, "현업부서")
      ], -1))
    ])
  ]))
}
const bill_flowchart = /*#__PURE__*/_export_sfc(_sfc_main, [['render',_sfc_render]]);

export { __pageData, bill_flowchart as default };
