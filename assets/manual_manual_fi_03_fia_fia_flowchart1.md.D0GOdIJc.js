...
const __pageData = JSON.parse("{\"title\":\"자산 취득 플로우차트\",\"description\":\"\",\"frontmatter\":{},\"headers\":[],\"relativePath\":\"manual/manual_fi_03/fia/fia_flowchart1.md\",\"filePath\":\"manual/manual_fi_03/fia/fia_flowchart1.md\"}");
const _sfc_main = {name:"manual/manual_fi_03/fia/fia_flowchart1.md"};
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  const _component_FI03fiaFlowChart1 = resolveComponent("FI03fiaFlowChart1");
  const _component_ClientOnly = resolveComponent("ClientOnly");

  return (openBlock(), createElementBlock("div", null, [
    _cache[5] || (_cache[5] = createBaseVNode("h1", {
      id: "자산-취득-플로우차트",
      tabindex: "-1"
    }, [
      createTextVNode("자산 취득 플로우차트 "),
      createBaseVNode("a", {
        class: "header-anchor",
        href: "#자산-취득-플로우차트",
        "aria-label": "Permalink to \"자산 취득 플로우차트\""
      }, "​")
    ], -1)),
      ...
      createBaseVNode("tr", _hoisted_2, [
        ...
        createBaseVNode("td", _hoisted_3, [
          createVNode(_component_ClientOnly, null, {
            default: withCtx(() => [
              createVNode(_component_FI03fiaFlowChart1)
            ]),
            _: 1
          })
        ])
...
const fia_flowchart1 = /*#__PURE__*/_export_sfc(_sfc_main, [['render',_sfc_render]]);

export { __pageData, fia_flowchart1 as default };
