...
const __pageData = JSON.parse("{\"title\":\"퇴직금 불입 플로우차트\",\"description\":\"\",\"frontmatter\":{},\"headers\":[],\"relativePath\":\"manual/manual_hr_04/hra/hra_flowchart2.md\",\"filePath\":\"manual/manual_hr_04/hra/hra_flowchart2.md\"}");
const _sfc_main = {name:"manual/manual_hr_04/hra/hra_flowchart2.md"};
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  const _component_HR04hraFlowChart3 = resolveComponent("HR04hraFlowChart3");
  const _component_ClientOnly = resolveComponent("ClientOnly");

  return (openBlock(), createElementBlock("div", null, [
    _cache[7] || (_cache[7] = createBaseVNode("h1", {
      id: "퇴직금-불입-플로우차트",
      tabindex: "-1"
    }, [
      createTextVNode("퇴직금 불입 플로우차트 "),
      createBaseVNode("a", {
        class: "header-anchor",
        href: "#퇴직금-불입-플로우차트",
        "aria-label": "Permalink to \"퇴직금 불입 플로우차트\""
      }, "​")
    ], -1)),
    ...
    createBaseVNode("table", _hoisted_1, [
      ...
      _cache[2] || (_cache[2] = createBaseVNode("tr", null, [
        ...
        createBaseVNode("td", null, "퇴직금 불입"),
      ...
      createBaseVNode("tr", _hoisted_2, [
        _cache[0] || (_cache[0] = createBaseVNode("td", { style: {"padding":"1px"} }, "연금운용사", -1)),
        createBaseVNode("td", _hoisted_3, [
          createVNode(_component_ClientOnly, null, {
            default: withCtx(() => [
              createVNode(_component_HR04hraFlowChart3)
            ]),
            _: 1
          })
        ])
      ]),
      _cache[4] || (_cache[4] = createBaseVNode("tr", { style: {"height":"200px"} }, [
        createBaseVNode("td", null, "인사팀")
      ], -1)),
      _cache[5] || (_cache[5] = createBaseVNode("tr", { style: {"height":"100px"} }, [
        createBaseVNode("td", { style: {"padding":"1px"} }, "재무회계팀")
      ], -1)),
      _cache[6] || (_cache[6] = createBaseVNode("tr", { style: {"height":"100px"} }, [
        createBaseVNode("td", null, "임직원")
      ], -1))
    ])
  ]))
}
const hra_flowchart2 = /*#__PURE__*/_export_sfc(_sfc_main, [['render',_sfc_render]]);

export { __pageData, hra_flowchart2 as default };
